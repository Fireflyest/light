...
const unsigned char F4x4[][4] =
    {
      {0x07, 0x05, 0x05, 0x07},  // 0
      {0x02, 0x06, 0x02, 0x07},  // 1
      {0x07, 0x01, 0x07, 0x07},  // 2
      {0x07, 0x01, 0x07, 0x07},  // 3
      {0x05, 0x05, 0x07, 0x01},  // 4
      {0x07, 0x04, 0x01, 0x07},  // 5
      {0x07, 0x04, 0x07, 0x07},  // 6
      {0x07, 0x01, 0x01, 0x01},  // 7
      {0x07, 0x05, 0x07, 0x07},  // 8
      {0x07, 0x05, 0x07, 0x01}   // 9
    };
